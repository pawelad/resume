...
\socialinfo{
  ...
  \githubSchema{pawelad} \\
  \gmailSchema{pawel.ad} \\
...
\begin{document}
  ...
  \begin{keywords}
    ...
    \keywordsentry{Databases}{\textbf{PostgreSQL}, MySQL, \textbf{Redis}, Elasticsearch, SQLite}
    \keywordsentry{Frameworks}{\textbf{Django}, \textbf{Django REST Framework}, Flask, FastAPI, Celery, \textbf{pytest}}
    \keywordsentry{Libraries}{\textbf{mypy}, \textbf{Pydantic}, httpx, Click, Rich, \textbf{black}, \textbf{Ruff}, Nox, tox, \textbf{pip-tools}, \textbf{MkDocs}}
    \keywordsentry{Tools}{\textbf{Docker}, \textbf{Docker Compose}, \textbf{Terraform}, CloudFormation, Ansible, git}
    \keywordsentry{Other}{\textbf{AWS}, \textbf{GitHub CI}, CircleCI, nginx, dokku, OpenAPI, JSON Schema, \textbf{Sentry}, Bootstrap}
  \end{keywords}
  ...
  \begin{experiences}
    \experience
      {Present}       {Senior Python Developer}{\link{https://narvi.com/}{Narvi}}{Remote}
      {November 2024} {
                        \begin{itemize}
                          \item Part of the main product backend team responsible for maintaining the current codebase and adding new features.
                          \item Implemented new automated anti money laundering checks (e.g. based on client IP address).
                        \end{itemize}
                      }
                      {Python,PostgreSQL,Django,Django REST Framework,Celery,Ansible,AWS}
    \emptySeparator
    \experience
