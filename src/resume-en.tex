...
\begin{document}
  ...
  \begin{keywords}
    ...
    \keywordsentry{Databases}{\textbf{PostgreSQL}, MySQL, \textbf{Redis}, Elasticsearch, Redshift, DynamoDB}
    \keywordsentry{Frameworks}{\textbf{Django}, \textbf{Django REST Framework}, Flask, FastAPI, Celery, \textbf{pytest}}
    \keywordsentry{Libraries}{\textbf{mypy}, \textbf{Pydantic}, httpx, Click, \textbf{black}, \textbf{Ruff}, Nox, tox, \textbf{pip-tools}, \textbf{MkDocs}}
    \keywordsentry{Tools}{\textbf{Docker}, \textbf{Docker Compose}, \textbf{Terraform}, CloudFormation, Ansible}
    \keywordsentry{Other}{\textbf{AWS}, nginx, dokku, OpenAPI, JSON Schema, \textbf{Sentry}, Bootstrap, GraphQL}
  \end{keywords}
  ...
  \begin{experiences}
    \experience
      {Present}       {Python Developer}{\link{https://narvi.com/}{Narvi}}{Remote / Helsinki, Finland}
      {November 2024} {
                        \begin{itemize}
    ...
    \emptySeparator
    \experience
      {November 2024} {Backend Engineer}{\link{https://twenty3.sport/}{Twenty3}}{Remote / Milton Keynes, UK}
      {August 2018}   {
                        \begin{itemize}
    ...
    \emptySeparator
    \experience
      {September 2016}{Python Developer}{\link{https://sidnet.info/}{Sidnet Solutions}}{Remote / Warsaw, Poland}
      {September 2015}{
                        \begin{itemize}
